...
After adding your new textures using images from your PC, go to File -> Save As.
...
- Encoding type: 0/2 = shift_jis_2004, 1 = UTF-16. (Former for DS2, latter for modern games)
